...
# 三渡与封穴数据：已确认机制按任务书；未确认概率/层数采用V1战斗参数。
rep('src/data.js',
...
'''
Path('src/battle.js').write_text(battle)

rep('index.html','单机精简版 · V0.12','单机精简版 · V0.13')
rep('sw.js',"const CACHE = 'xinyitian-v0.12.0';","const CACHE = 'xinyitian-v0.13.0';")
